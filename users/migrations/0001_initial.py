# Generated by Django 4.2.23 on 2025-06-27 10:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PATIENT', 'Patient'), ('DOCTOR', 'Doctor'), ('HOSPITAL', 'Hospital')], default='PATIENT', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='doctors', to='users.hospital')),
